...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
    ...
    if (!is_initialized_) {
        ...
        */
        ...
        ekf_.x_ = VectorXd(4);
        ekf_.x_ << 1, 1, 1, 1;
        // initialized ekf_.x_ based on measurement type
        if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
            ...
            */
            ...
            Initialize state.
            */
            // We don't know velocities from the first measurement of the LIDAR, so, vx and vy is 0
            ekf_.x_ <<
    ...
    ekf_.F_ << 1, 0, dt, 0,
            ...
            0, 0, 1, 0,
            0, 0, 0, 1;
//    above code is used for clarity, we can also update F as:
//    ekf_.F_(0, 2) = dt;
//    ekf_.F_(1, 3) = dt;
